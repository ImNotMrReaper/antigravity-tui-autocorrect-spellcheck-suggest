...
- **Interactive PTY Supervisor (`agy-tui` / `agy`):** Transparent zero-latency PTY wrapper intercepting keystrokes and handling terminal window resizing (`SIGWINCH`), Ctrl+C interrupts, and clipboard pastes smoothly.
